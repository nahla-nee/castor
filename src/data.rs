...
use druid::{text::{RichTextBuilder, RichText}, im, Data, Lens, FontWeight, FontFamily, Widget, widget::{Flex, Button, TextBox}, Color, WidgetExt};
use leda::gemini;

use crate::{controllers::InputWrapper, delegate::{self, PAGE_LOADED}, widgets::Scroll};
...
impl CastorState {
    ...
    pub fn load_page(&mut self, url: String) {
        let result = self.gemini_client.borrow_mut().request(url.clone())
